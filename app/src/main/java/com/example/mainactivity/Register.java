...
public class Register extends AppCompatActivity {
    ...
    EditText mFullName, mEmail, mPassword, mPhone, mName, mAddress, mCity, mDOB, mNIC, mGender;
    Button mRegisterBtn;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String nic = mNIC.getText().toString();
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            user.put("verificationCode", verificationCode); // Save verification code
                            ...
                            // You need to implement email sending here
